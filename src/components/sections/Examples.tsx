      ...
      <div className="relative py-6">
        ...
        >
          {examples.map((example) => (
            ...
            >
              <article 
                  className="relative aspect-9/16 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl cursor-pointer transition-all duration-500 hover:shadow-3xl hover:scale-105"
